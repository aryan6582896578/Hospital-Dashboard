    ...
    return(
      <div className="bg-white justify-between flex-col flex min-w-fit" >
        <div className="min-w-fit flex flex-col">
            <Link to="/dashboard">
            <div className="h-20 mt-[10px] flex items-center border-b border-[#e8edf2] ">
            ...
            <div className="mt-[20px] flex flex-col mb-[20px] ">
                <div className="flex lg:flex-col ">
                    <Link to="/dashboard"> <button className="flex  rounded-[5px] hover:bg-slate-100 cursor-pointer p-[10px] pl-[20px] pr-[20px]  lg:ml-auto lg:mr-auto  mt-[10px] lg:min-w-[90%] min-w-fit"> <HomeIcon className="mr-[10px] text-blue-600"/>Home</button></Link>
                    {userRole.roleType==="admin" && 
                        <div className="flex lg:flex-col">
                            <Link to="/dashboard/admin/manageuser"> <button className="flex  rounded-[5px] hover:bg-slate-100 cursor-pointer p-[10px] pl-[20px] pr-[20px]  lg:ml-auto lg:mr-auto  mt-[10px] lg:min-w-[90%] min-w-fit"> <UserSearch className="mr-[10px] text-blue-600"/>Users </button></Link>
                            <Link to="/dashboard/admin/managehospital"> <button className="flex  rounded-[5px] hover:bg-slate-100 cursor-pointer p-[10px] pl-[20px] pr-[20px]  lg:ml-auto lg:mr-auto mt-[10px] lg:min-w-[90%] min-w-fit"> <Hospital className="mr-[10px] text-blue-600"/>Hospitals </button></Link>
                        </div>
                    }
                </div>
                <button className="flex rounded-[5px] hover:bg-red-100 hover:border-red-300 cursor-pointer p-[10px] pl-[20px] pr-[20px]  lg:ml-auto lg:mr-auto lg:min-w-[90%]  mt-[10px] text-red-500 w-fit" onClick={()=>{
                    logout()
